...
- **is_in_scope**: 布尔值(true/false)。判断该文章是否属于【Data&AI 产品洞察】范围。标准：涉及数据/AI领域的产品、技术、框架、行业应用或重要观点。若为纯通用软件开发、非AI相关的硬件、纯政治新闻、娱乐八卦等，则为 false。
- **scope_reason**: 简短说明判断原因（例如：涉及大模型发布、非AI相关新闻等）。
